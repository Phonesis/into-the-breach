  ...
  germany: {
    ...
    units: {
      ...
      infantry: {
        ...
        description: 'Kar98k rifles, MP40 SMGs, and squad MG34 — effective to ~420 m.',
        hp: 80,
        damage: 12,
        range: 42,
        rangeMeters: 420,
  ...
  usa: {
    ...
    units: {
      ...
      infantry: {
        ...
        description: 'M1 Garands, Thompson SMGs, and BAR — effective to ~500 m.',
        hp: 85,
        damage: 11,
        range: 38,
        rangeMeters: 500,
  ...
  uk: {
    ...
    units: {
      ...
      infantry: {
        ...
        description: 'Lee–Enfield rifles, Sten SMGs, and Bren — effective to ~450 m.',
        hp: 82,
        damage: 10,
        range: 36,
        rangeMeters: 450,
  ...
  russia: {
    ...
    units: {
      ...
      infantry: {
        ...
        description: 'Mosin-Nagant rifles, PPSh-41 SMGs, and DP-27 LMG — effective to ~430 m.',
        hp: 84,
        damage: 11,
        range: 40,
        rangeMeters: 430,
  ...
  japan: {
    ...
    units: {
      ...
      infantry: {
        ...
        description: 'Type 99 Arisaka rifles, Type 100 SMGs, and Type 96 LMG — effective to ~450 m.',
        hp: 82,
        damage: 10,
        range: 38,
        rangeMeters: 450,
