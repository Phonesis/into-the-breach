...
const engineerGermany = {
  engineer: {
    ...
    description: 'Combat engineers — repair nearby vehicles, steady panicked crews, and erect sandbag heavy-cover positions.',
    hp: 56,
    damage: 0,
    range: 0,
    rangeMeters: 0,
...
const engineerUSA = {
  engineer: {
    ...
    description: 'Field engineers — restore HP to armor and guns within 16 m; can build sandbag heavy-cover emplacements.',
    hp: 58,
    damage: 0,
    range: 0,
    rangeMeters: 0,
...
const engineerRussia = {
  engineer: {
    ...
    description: 'Field sappers — repair armor and guns within ~16 m; can erect sandbag heavy-cover positions.',
    hp: 57,
    damage: 0,
    range: 0,
    rangeMeters: 0,
...
const engineerUK = {
  engineer: {
    ...
    description: 'Sapper section — maintains tanks, guns, and carriers; can build sandbag heavy-cover emplacements.',
    hp: 55,
    damage: 0,
    range: 0,
    rangeMeters: 0,
