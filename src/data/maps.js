...
export const MAPS = {
  ...
  lineEffectivenessTest: {
    id: 'lineEffectivenessTest',
    name: 'Line Test Range',
    subtitle: 'Temporary QA range — AT mine belt and retreating infantry position',
    terrain: 'steppe',
    groundColor: 0x6b7a4a,
    groundColor2: 0x596840,
    fogColor: 0x9aa88a,
    fogDensity: 0.0048,
    skyColor: 0x7a8a9a,
    size: 100,
    defaultMapSize: 'small',
    mapSizeOptions: ['small'],
    playerBase: { x: -43, z: 0 },
    enemyBase: { x: 43, z: 0 },
    frontline: { x: 0, z: 0, name: 'Test Line' },
    capturePoints: [],
    features: ['Enemy AT mine belt', 'Four vehicle dummies', 'Hold Ground / Pursue lane'],
    testScenario: 'lineEffectiveness',
  },
  northAfrica: {
    id: 'northAfrica',
    name: 'North Africa',
