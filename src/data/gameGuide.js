...
export const GAME_GUIDE_SECTIONS = [
  ...
  },
  {
    ...
    controls: [
      ...
      ['Esc', 'Cancel fire-support targeting, active unit fire missions, engineer sandbag placement, Last Stand placement, or pending TD build'],
  ...
  },
  {
    ...
    body: [
      ...
      '<strong>Engineer sandbags:</strong> Select an engineer → <strong>Build sandbags</strong> → LMB within ~24 m. The engineer moves to the site and erects a fighting position (~11 s) that grants <strong>heavy cover</strong> to foot troops. Positions can be destroyed by fire like map cover. Not available in Tower Defence. Esc cancels placement.',
