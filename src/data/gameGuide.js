...
export const GAME_GUIDE_SECTIONS = [
  ...
  },
  {
    ...
    body: [
      ...
      'Open the <strong>Base Construction</strong> panel (bottom HUD), pick a structure, then <strong>LMB</strong> the map in the ring around your HQ. During <strong>quiet sector</strong> neither side may start or progress base construction — launch battle first. Structures cost supplies upfront and take time to finish once the battle is underway. Enemy AI expands its base the same way.',
