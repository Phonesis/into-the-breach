...
export const GAME_GUIDE_SECTIONS = [
  ...
  },
  {
    ...
    controls: [
      ...
      ['Tablet / touch', 'Camera pad (bottom-right): pan, rotate, zoom · pinch battlefield to zoom · long-press map with units selected = move/attack · <code>?tablet=1</code> forces tablet UI on desktop'],
  ...
  },
  {
    ...
    body: [
      ...
      'On tablets and phones, a <strong>camera pad</strong> appears at the bottom-right for pan, rotate, and zoom. Pinch the battlefield to zoom in and out. With units selected, <strong>long-press</strong> the map to issue a move or attack order (replaces right-click on mouse).',
    ],
  },
  {
    id: 'economy',
