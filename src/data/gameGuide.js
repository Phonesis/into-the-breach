...
export const GAME_GUIDE_SECTIONS = [
  ...
  },
  {
    ...
    title: 'Game modes',
    body: [
      '<strong>Standard</strong> — Full skirmish vs AI on any map. Pick Easy, Medium, or Hard. On the theater screen choose <strong>Classic</strong> (single HQ — all unit types from headquarters) or <strong>Base Building</strong> (<strong>Large map only</strong> — build an <strong>Infantry Garrison</strong> and depots from HQ; train units at completed structures; expand at <strong>captured sectors</strong>). Both styles start <strong>each side</strong> with a <strong>radio operator and infantry squad</strong>; Classic exposes all unit types from HQ while Base Building unlocks them through structures. Longer-paced fights: tougher units, slower damage, slower income/production.',
      '<strong>Clear Defenses</strong> — Dug-in positions across the map; <em>no HQ, capture points, or sector economy</em>. On the theater options screen choose <strong>Attack</strong> or <strong>Defend</strong> alongside reinforcement size — both sides are auto-deployed (no manual placement). As <strong>Attacker</strong> you get a fixed assault force in a layered rear assembly and must wipe every defender. As <strong>Defender</strong> you hold the prepared trench belt and must destroy the AI assault force. <strong>Lose if your entire force is wiped out</strong> before later reinforcement waves can restore the line.',
      'Both sides receive automatic <strong>reinforcement groups every 3 minutes</strong> at their rear assembly (assault packages vs garrison packages match the role). On the <strong>Select Theater</strong> screen choose package size: <strong>Small</strong> (two units), <strong>Medium</strong> (three to four), or <strong>Large</strong> (five to six). Enemy command repeatedly reassesses surviving strength, damage, local pressure, and fresh arrivals. When you attack, the AI garrison remains <strong>defence-focused</strong>: it preserves prepared positions, conducts controlled fallback when a sector is overwhelmed, and releases limited probing counterattacks only when conditions permit. When you defend, the AI assault remains <strong>attack-focused</strong>: its chosen plan (infantry push, armored thrust, flanking hook, fire preparation, or combined arms) drives renewed assault waves, with short regroup-and-hold phases when badly mauled. Both you and the AI can call <strong>off-map fire support</strong> (strafe, barrage, creep, airborne); in this mode each side may use <strong>Airborne only once</strong>, after the opening cloud-cover restriction clears.',
      ...
      'No HQ or sector economy in either style. Strafe and artillery fire support unlock once battle begins. Airborne remains grounded by opening cloud cover for the battle’s first <strong>5 minutes</strong>; after conditions clear, each side may use <strong>Airborne only once</strong> in Battle Simulation. Win by destroying every enemy unit; lose if your army is wiped out.',
    ],
  },
  {
    id: 'battle-report',
  ...
  },
  {
    ...
    controls: [
      ...
      ['Ctrl + R', 'Select the nearest available radio operator to the current selection, or to the camera centre'],
      ...
      ['Unit status toggle', 'Forces panel header — show or hide floating status markers such as INSPIRED, IN COVER, RETREAT, and support/repair markers (saved between sessions)'],
  ...
  },
  {
    ...
    body: [
      ...
      'The <strong>Unit status</strong> button in the Forces header toggles floating status markers such as <strong>INSPIRED</strong>, <strong>IN COVER</strong>, <strong>RETREAT</strong>, surrender, and medic/engineer support feedback. Your choice is remembered in the browser. This does not hide rank badges, selection-panel details, or battlefield effects such as engine smoke.',
  ...
  },
  {
    ...
    body: [
      ...
      'Enemy AI can call off-map support in Standard, Assault &amp; Defend, Clear Defenses, and active Battle Simulation, and can construct sandbags, field bunkers, and trenches when it has suitable units. It also moves eligible infantry into buildings and cover. <strong>Medics</strong> move to heal wounded foot troops, and <strong>engineers</strong> move to repair damaged vehicles, broken tracks/wheels, recoverable wrecks, and a damaged HQ.',
    ],
  },
  {
    id: 'combat',
    ...
    body: [
      ...
      'Idle combat units automatically acquire and fire at the nearest valid visible enemy inside weapon range. Their per-unit <strong>engagement stance</strong> controls only that idle behaviour: <strong>Hold Ground</strong> (default) does not advance after auto-acquired targets and will not start a chase on its own; <strong>Pursue</strong> will close on and follow enemies that enter range then flee. <strong>Any explicit attack order</strong> (LMB/RMB on an enemy) always binds and is followed — units close to range, keep the order if the target moves or is briefly masked by buildings, and route for a clear shot. Switching stance applies immediately to idle behaviour. Select one or several units and choose the stance in the selection panel. Damage falls off with distance. <strong>Infantry, paratroopers, and engineers</strong> use dispersed wedge, staggered-column, line, and echelon formations; squads smoothly reorganize into a different formation when they begin a new movement. Stationary squads automatically go prone while firing, then rise again when ordered to move. Mounted troops and soldiers fighting from trenches keep their appropriate mounted or dug-in stance.',
      '<strong>Line of sight:</strong> intact buildings stop direct rifle, machine-gun, tank, tank-destroyer, and anti-tank fire. <strong>Artillery</strong> fires high-angle: shells go <strong>over</strong> buildings and other large obstacles that lie beyond the howitzer\'s minimum range (~220 m). A large obstacle <em>inside</em> that min-range ring still blocks the muzzle — the shell strikes it until the structure is destroyed. Player howitzers do <strong>not</strong> auto-fire by default — select them and toggle <strong>Auto-fire</strong> On to engage enemies in range (same rules as enemy batteries). Ordered attack, ground, smoke, and building fire missions always work without that toggle. Mortars also lob over buildings. Deliberate shots at a distant building land on that façade after flight. Off-map barrages remain fully indirect.',
      ...
      '<strong>Armor penetration:</strong> Direct tank, anti-tank-gun, and infantry anti-tank shots test the weapon against the target vehicle\'s historical protection, impact range, armor facing, slope, and horizontal strike angle. Glancing or underpowered hits <strong>ricochet with a bright metallic spark shower and no hull damage</strong>. Each hit lands on a sampled part of the vehicle silhouette; penetrations through rear engine decks, ammunition stowage, turret rings, driver visors, and open fighting compartments have a chance to become a high-damage <strong>critical hit</strong>. Low strikes can break tracks or wheels. Jagdpanther and SU-100 frontal slopes are especially effective, while the open-topped M10 and Achilles trade protection for powerful guns. Flank heavy armor instead of trading shots against its front plate.',
      ...
      'Destroyed units leave permanent wrecks on the field: <strong>burning tanks</strong>, <strong>fallen infantry bodies</strong> (faction camo, prone on the ground), and knocked-out vehicles. Foot troops killed by large HE (artillery, tank shells, and similar blasts) are thrown bodily by the explosion before landing as corpses — occasional gibs still apply. <strong>Tracked tanks can drive directly over enemy anti-tank guns and field artillery, crushing the operating crew and smashing the carriage; they also grind prone and dug-in enemy troops beneath their tracks.</strong> Corpses and wrecks are retained in saved games. Vehicle wrecks provide neutral cover to foot troops from <strong>either side</strong>. About <strong>one third</strong> of tank, super-heavy, and armored-car knockouts are recoverable: a smaller explosion and persistent smoke mark the shell-damaged hull, its turret stays in place, and a two-man crew visibly climbs from the hatch to continue fighting with small arms. An engineer can restore the hull even if those crewmen later die; infantry or paratroopers can then reman it. A lethal rear hit has a high chance to trigger a catastrophic ammunition chain reaction; those vehicles produce no survivors and cannot be repaired. Cover and retreat markers disappear on death.',
      'Small-arms tracers only; tanks, AT guns, and artillery use shell-impact VFX and calibre-weighted reports. Barrages and creeping barrages begin with distant battery salvos and use heavy shell explosions. <strong>Mortar bombs and artillery shells</strong> lock their aim point when fired and land after a short flight — a unit that keeps moving can walk clear of the blast. Heavy fire permanently scars terrain with craters for the rest of the battle. <strong>Mortar teams</strong> stow their weapon while moving, deploy it when stationary, turn the elevated tube toward their target, and fire from the actual tube muzzle with a deliberate reload between bombs.'
    ],
  },
  {
    id: 'cover',
    ...
    },
  {
    ...
    body: [
      ...
      '<strong>Radio link required:</strong> fire support no longer depends on the field commander. At least one living radio operator must remain; losing the commander sharply worsens morale but does not silence surviving operators. Multiple operators can keep support available if one is killed.',
      ...
      '<strong>Airborne drop</strong> (~180 s cooldown) — <strong>Opening cloud cover grounds all airborne operations for the first 5 minutes of every mode, for both player and AI.</strong> The Airborne button shows the weather countdown; Battle Simulation setup time does not count toward it. Once conditions clear, a transport passes overhead and <strong>five elite paratrooper squads</strong> (four men each) descend by parachute on your target zone. Drops cannot target within about <strong>48 m of the opposing HQ</strong>, preventing an immediate HQ assault; Battle Simulation and Clear Defenses are unaffected when no HQ exists. They are <strong>not</strong> built from HQ — only called this way. On landing they fight with <strong>rifles and squad LMG</strong> vs infantry and <strong>anti-tank launchers</strong> (Panzerfaust, bazooka, PIAT, RPG-43, etc. by nation) vs tanks, tank destroyers, and armored cars. AT shots reload slowly (~4.5 s). In <strong>Clear Defenses</strong> and <strong>Battle Simulation</strong>, each side may call Airborne <strong>only once</strong> for the whole match (button shows Used after the drop).',
      '<strong>Radio range and observation:</strong> strafing runs, artillery barrages, creeping barrages, and airborne drops may target only ground within about <strong>72 m of at least one living radio operator</strong> and with a clear line of sight from that operator. Buildings and smoke can block the call. The targeting ring turns red outside the radio net, and the enemy AI follows the identical restriction.',
  ...
  },
  {
    ...
    body: [
      ...
      '<strong>Field commander required:</strong> if your commander is killed, any active general order is cancelled and Full Retreat / Hold Ground remain unavailable for the rest of the battle. The commander itself is not pulled forward by a Full Retreat order.',
      ...
      '<strong>Seek Cover</strong> — Persistent toggle (no cooldown). When <strong>On</strong>, right-click move orders for commanders, infantry, airborne, engineers, medics, MG teams, mortar crews, and snipers snap to the nearest cover zone near the destination. When <strong>Off</strong>, units move to the ground you clicked. Does not affect tanks, anti-tank guns, or artillery. Saved between sessions.',
  ...
  },
  {
    ...
    title: 'Unit roster',
    intro:
      'Thirteen buildable unit types per faction (historical names differ). <strong>Radio operators</strong> are one-man signals units that enable off-map support; <strong>Airborne paratroopers</strong> remain fire-support only (see Fire support). Icons match the Forces panel. Costs are supplies; build times are base seconds (longer in Standard).',
    units: true,
  },
  {
    id: 'difficulty',
...
export const GUIDE_UNIT_CARDS = [
  ...
  },
  {
    ...
    cost: 58,
    build: 10,
    range: 'Support to ~720 m · rifle ~400 m',
    desc: 'One-man signals unit with a faction-specific backpack radio and rifle-only armament. Enables off-map fire support and airborne calls only within its range and clear line of sight; can dig and occupy trenches; additional operators extend the net and provide redundancy.',
    tags: ['Signals', 'Rifle', 'Trench', 'Fire support', 'Airborne', 'Single man'],
  },
  {
    type: 'medic',
    name: 'Medic',
