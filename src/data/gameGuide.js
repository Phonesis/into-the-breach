...
export const GAME_GUIDE_SECTIONS = [
  ...
  },
  {
    ...
    body: [
      ...
      'Every side deploys one faction-specific <strong>field commander</strong> at its rear map edge in every mode. The officer stands at the centre of a four-man bodyguard group and carries a permanent gold (friendly) or red (enemy) <strong>CMD star</strong> field symbol, also marked with a star on the tactical map. Enemy AI keeps its commander behind the fighting line; the commander does not count toward normal army-wipe or wave-clear conditions.',
    ...
    },
  {
    ...
    body: [
      ...
      '<strong>Command link required:</strong> fire support is available only while your field commander is alive. Killing the enemy commander removes the enemy AI’s off-map support as well. A faction-language radio announcement confirms a commander loss.',
      ...
      '<strong>Observed targets only:</strong> strafing runs, artillery barrages, creeping barrages, and airborne drops may target only ground that is within observation range and has a clear line of sight from at least <strong>one living friendly unit</strong>. Buildings and smoke can block observation. The targeting ring turns red over unseen ground, and the enemy AI follows the identical restriction.',
      'Click a strike type, then LMB on valid observed ground. Esc cancels targeting. Not available in Tower Defence (Emplacements) or during Battle Simulation deployment; otherwise available once its mode restrictions and the five-minute cloud-cover period have cleared in Tower Defence HQ Defense, Standard, Assault, Clear Defenses, Battle Simulation, and Training. The enemy AI follows the same weather, command-link, cooldown, observation, targeting, and per-mode use rules.',
    ],
  },
  {
    id: 'generalorders',
