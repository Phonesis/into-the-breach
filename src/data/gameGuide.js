...
export const GAME_GUIDE_SECTIONS = [
  ...
  },
  {
    ...
    controls: [
      ...
      ['Settings', 'Main menu — choose persistent AI difficulty, battlefield toggles, Standard Auto Build, and how long bodies and destroyed vehicles remain'],
      ...
      ['Tablet / touch', 'Camera pad: pan, rotate, zoom · <strong>Target</strong> = tap enemy to highlight, tap again or Engage to attack · <strong>Fire</strong> = tap ground/cover (Shift+LMB) · tap the map with units selected = move/attack · on tablets, use Settings → Tablet controls to switch to the normal keyboard/mouse scheme when a keyboard is connected · <code>?tablet=1</code> forces tablet UI'],
