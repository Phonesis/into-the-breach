...
export const GAME_GUIDE_SECTIONS = [
  ...
  },
  {
    ...
    body: [
      ...
      'Enemy AI can call off-map support in Standard, Assault &amp; Defend, and active Battle Simulation, and can construct sandbags, field bunkers, and trenches when it has suitable units. It also moves eligible infantry into buildings and cover. <strong>Medics</strong> move to heal wounded foot troops, and <strong>engineers</strong> move to repair damaged vehicles, broken tracks/wheels, recoverable wrecks, and a damaged HQ.',
    ],
  },
  {
    id: 'combat',
