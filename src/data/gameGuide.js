...
export const GAME_GUIDE_SECTIONS = [
  ...
  },
  {
    ...
    body: [
      ...
      'Both sides receive automatic <strong>reinforcement groups every 3 minutes</strong> at their rear assembly (assault packages vs garrison packages match the role). On the <strong>Select Theater</strong> screen choose package size: <strong>Small</strong> (two units), <strong>Medium</strong> (three to four), or <strong>Large</strong> (five to six). When you attack, the AI garrison launches frequent <strong>probing counterattacks</strong>. When you defend, the AI assault uses varied battle plans (infantry push, armored thrust, flanking hook, fire preparation, or combined arms) with the units it has. Both you and the AI can call <strong>off-map fire support</strong> (strafe, barrage, creep, airborne); in this mode each side may use <strong>Airborne only once</strong>, after the opening cloud-cover restriction clears.',
