...
export const GAME_GUIDE_SECTIONS = [
  ...
  },
  {
    ...
    body: [
      ...
      '<strong>Tower Defence</strong> also tallies <strong>emplacements lost</strong> — bunkers, nests, wire, mines, and artillery pits destroyed during the battle.',
  ...
  },
  {
    ...
    controls: [
      ...
      ['Esc', 'Cancel fire-support targeting, active unit fire missions, engineer sandbag placement, campaign base construction, Last Stand placement, or pending TD build'],
  ...
  },
  {
    ...
    body: [
      ...
      'Units spawn at the structure you selected when queuing them. Engineer field sandbags are disabled in this mode — use bunkers for heavy cover.',
  ...
  },
  {
    ...
    body: [
      ...
      '<strong>Engineer sandbags:</strong> Select an engineer → <strong>Build sandbags</strong> → LMB within ~24 m. The engineer moves to the site and erects a fighting position (~11 s) that grants <strong>heavy cover</strong> to foot troops. Positions can be destroyed by fire like map cover. Not available in Tower Defence or Campaign Base Building (use bunkers there). Esc cancels placement.',
      '<strong>Campaign bunkers:</strong> In Base Building mode, completed <strong>Infantry Bunkers</strong> garrison foot troops — move a squad onto the bunker to enter. Garrisoned units take heavy-cover damage reduction and fight from the embrasures. Order a move away to exit.',
...
export const GUIDE_UNIT_CARDS = [
  ...
  },
  {
    ...
    build: 10,
    range: '—',
    desc: 'Non-combat — repairs vehicles within ~16 m; can build heavy-cover sandbag emplacements in the field.',
