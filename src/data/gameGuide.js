...
export const GAME_GUIDE_SECTIONS = [
  ...
  },
  {
    ...
    body: [
      ...
      '<strong>Auto Build</strong> (Standard — Classic and Base Building): toggle <strong>On</strong> in the Reinforcements panel header. The game keeps the queue full (up to four slots) with a realistic combined-arms mix — infantry backbone, MG and mortar support, AT, armor, artillery, medics, and engineers — weighted by what you already have on the field and what you can afford. You can still click unit buttons to queue manually; auto build only fills empty slots. Preference is saved in the browser and restored with saved games. Not available in Training, Assault, Tower Defence, or Battle Simulation.',
