...
export const GAME_GUIDE_SECTIONS = [
  ...
  },
  {
    ...
    title: 'Game modes',
    body: [
      '<strong>Campaign</strong> — Full skirmish vs AI on any map. Pick Easy, Medium, or Hard. Longer-paced fights: tougher units, slower damage, slower income/production, larger opening armies.',
      '<strong>Clear Defenses</strong> — Dug-in defenders across the map; <em>no enemy HQ</em>. Destroy every defender. Your army stages behind your HQ; defenders hold fire ~10 s at start.',
      ...
      '<strong>Assault &amp; Defend</strong> — Attack or Defend. Central frontline (★) must be seized or held. Attackers can also win by destroying the defender HQ or wiping defenders; defenders win by surviving 8 minutes, destroying the assault HQ, or eliminating the assault when they cannot reinforce.',
    ],
  },
  {
    id: 'controls',
    ...
    controls: [
      ...
      ['Shift + LMB', 'Fire mission on open ground (in range)'],
      ['Alt + click', 'Order attack on trees, hedges, bunkers (cover scenery)'],
  ...
  },
  {
    ...
    body: [
      ...
      'Tanks and <strong>super heavy tanks</strong> resist rifles/MGs (~20% damage). Super heavies are slower, tougher, and hit harder. Mortars, tank guns, and artillery are strong anti-armor.',
  ...
  },
  {
    ...
    title: 'Cover',
    body: [
      'Infantry and machine-gun teams only. Tanks, super heavies, mortars, and artillery ignore cover bonuses.',
      ...
      'Bonus only while the unit stays in the zone. Hold <strong>Alt</strong> and attack scenery to destroy cover objects. Selected infantry/MG show an <strong>IN COVER</strong> tag, foot ring, and % on the selection panel.',
    ],
  },
  {
    id: 'firesupport',
  ...
  },
  {
    ...
    title: 'Unit roster',
    intro:
      'Eight unit types per faction (historical names differ). Icons match the Forces panel. Costs are supplies; build times are base seconds (longer in Campaign).',
    units: true,
  },
  {
    id: 'difficulty',
...
export const GUIDE_UNIT_CARDS = [
  ...
  },
  {
    ...
    build: 18,
    range: '~1,200–1,500 m',
    desc: 'Medium armor breakthrough; weak to dedicated anti-tank.',
  ...
  },
  {
    ...
    build: '27–29',
    range: '~1,450–1,600 m',
    desc: 'Slow, very tough, heavy gun — highest supply cost.',
