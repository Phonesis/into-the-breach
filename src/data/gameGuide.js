...
export const GAME_GUIDE_SECTIONS = [
  ...
  },
  {
    ...
    body: [
      ...
      '<strong>Infantry trenches:</strong> Select infantry, MG, or sniper → <strong>Dig trench</strong> → LMB within ~18 m. The squad digs for ~14 s, then drops into the trench (crouched). Other foot troops can move onto a friendly trench to dig in for medium-heavy cover. Order a move to leave. Esc cancels placement.',
...
export const GUIDE_UNIT_CARDS = [
  ...
  },
  {
    ...
    build: 10,
    range: '—',
    desc: 'Non-combat — repairs vehicles and damaged HQ within ~16 m; can erect sandbag pits or bunkers in the field in all modes (bunkers only in Base Building).',
