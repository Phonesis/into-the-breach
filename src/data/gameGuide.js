...
export const GAME_GUIDE_SECTIONS = [
  ...
  },
  {
    ...
    body: [
      ...
      '<strong>Campaign bunkers:</strong> Engineer field bunkers in <strong>Classic</strong> Campaign, or <strong>Infantry Bunkers</strong> from HQ (95 supplies) in Base Building, garrison up to <strong>2</strong> foot troops each. Move units onto the bunker to enter; order a move away to exit.',
