...
export const GUIDE_UNIT_CARDS = [
  ...
  },
  {
    ...
    build: 10,
    range: '~380 m',
    desc: 'Combat engineer squad (4) — rifles and SMGs for self-defence; repairs vehicles and HQ within ~16 m; erects sandbags and bunkers in the field (bunkers only in Base Building).',
    tags: ['Rifle', 'Repair', 'Build', 'Support'],
  },
  {
    type: 'machineGun',
    name: 'Machine gun',
