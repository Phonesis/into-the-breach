...
export const GAME_GUIDE_SECTIONS = [
  ...
  },
  {
    ...
    body: [
      ...
      '<strong>Dig In</strong> — Every currently free commander, radio operator, infantry or airborne squad, MG team, and sniper team attempts to dig a trench at or near its present position. Trenches face the centre of the living enemy force (or the enemy base when no enemy is visible), and each digger automatically occupies its completed position. Cancelling within the 30 s command window stops unfinished order-created trenches; completed trenches remain.',
