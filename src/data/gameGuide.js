...
export const GAME_GUIDE_SECTIONS = [
  ...
  },
  {
    ...
    body: [
      ...
      'No HQ or sector economy in either style. Fire support (strafe, barrage, creep, airborne) unlocks once battle begins — in Battle Simulation each side may use <strong>Airborne only once</strong>. Win by destroying every enemy unit; lose if your army is wiped out.',
    ],
  },
  {
    id: 'battle-report',
    ...
    },
  {
    ...
    body: [
      ...
      'Click a strike type, then LMB on valid ground. Esc cancels targeting. Not available in Tower Defence (Emplacements) or during Battle Simulation deployment; available once battle is live in Tower Defence HQ Defense, Standard, Assault, Clear Defenses, Battle Simulation, and Training. The enemy AI uses the same off-map options in those modes (including Clear Defenses and Battle Simulation).',
    ],
  },
  {
    id: 'generalorders',
