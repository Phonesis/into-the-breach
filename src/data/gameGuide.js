...
export const GAME_GUIDE_SECTIONS = [
  ...
  },
  {
    ...
    body: [
      ...
      'Idle combat units automatically acquire and fire at the nearest valid visible enemy inside weapon range. Their per-unit <strong>engagement stance</strong> controls direct enemy-unit orders: <strong>Hold Ground</strong> is the default, accepts only targets already in weapon range, never advances after them, and drops the order if they leave range; if masonry temporarily obscures an in-range target, the unit holds the order and waits for a clear shot. <strong>Pursue</strong> accepts out-of-range targets, closes to weapon range, follows a retreating target, and routes around buildings until it has both range and line of sight. Switching stance applies immediately. Explicit attacks on <strong>buildings</strong> may advance in either stance. Select one or several units and choose the stance in the selection panel. Damage falls off with distance. <strong>Infantry, paratroopers, and engineers</strong> use dispersed wedge, staggered-column, line, and echelon formations; squads smoothly reorganize into a different formation when they begin a new movement. Stationary squads automatically go prone while firing, then rise again when ordered to move. Mounted troops and soldiers fighting from trenches keep their appropriate mounted or dug-in stance.',
      '<strong>Line of sight:</strong> intact buildings stop direct rifle, machine-gun, tank, tank-destroyer, and anti-tank fire. A selected target remains ordered while temporarily obscured; Pursue units maneuver for a firing lane, while Hold units stay in place. Mortars, artillery, and off-map barrages use indirect fire and can engage over buildings.',
      ...
      '<strong>Vehicle handling &amp; gun feedback:</strong> tracked vehicles pivot at a deliberate hull-traverse speed instead of snapping instantly, with track-and-engine audio while turning in place. Accepted attack orders play a faction-specific radio acknowledgement. Tank main guns use heavier cannon reports; anti-tank and artillery pieces visibly eject brass cases that scatter beside the gun and remain on the battlefield.',
      ...
      'Small-arms tracers only; tanks, AT guns, and artillery use shell-impact VFX and calibre-weighted reports. Barrages and creeping barrages begin with distant battery salvos and use heavy shell explosions. Every mortar round produces a visible medium shell explosion where it lands. Heavy fire permanently scars terrain with craters for the rest of the battle. <strong>Mortar teams</strong> stow their weapon while moving, deploy it when stationary, turn the elevated tube toward their target, and fire from the actual tube muzzle.',
    ],
  },
  {
    id: 'cover',
