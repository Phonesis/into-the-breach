...
export const GAME_GUIDE_SECTIONS = [
  ...
  },
  {
    ...
    body: [
      ...
      '<strong>Tower Defence</strong> — No player army. On the theater screen choose <strong>Wave Mode</strong>: <strong>12 Waves</strong> (win by repelling all 12) or <strong>Endless</strong> (survive as long as you can; waves keep scaling past wave 12). Assaults hit <strong>sections of the frontline</strong> from different angles — early waves push the center; from roughly <strong>wave 10</strong> onward expect wider <strong>multi-sector flanking</strong> (the prepare banner shows threatened sectors). Spend <strong>defense points</strong> on bunkers, MG nests, <strong>mortar pits</strong>, AT guns, <strong>AT mines</strong> (vehicles only), barbed wire, and <strong>artillery pits</strong> (max <strong>3</strong>). Emplacements <strong>take damage</strong> and can be <strong>upgraded</strong> (select with LMB → Upgrade) to heavier bunkers, .50 cal, 120 mm mortars, 88 mm, razor wire, or 155 mm pits. Guns fire automatically; <strong>barrage</strong> needs an artillery pit — each extra pit <strong>shortens barrage cooldown</strong> by 6 s. Between waves, use <strong>Start Wave Now</strong> on the countdown banner to skip the prepare timer. Lose if the line is breached or your HQ falls.',
  ...
  {
    id: 'base-building',
    title: 'Campaign — Base Building',
    body: [
      'Choose <strong>Base Building</strong> on the theater screen (Campaign only). Each side starts with a <strong>single infantry squad</strong> only. Click your <strong>HQ</strong> to train <strong>infantry</strong>; click a completed <strong>depot</strong> on the map to open that building\'s unit menu (e.g. Motor Pool → tanks).',
      ...
      '<strong>Motor Pool</strong> (260 supplies, ~55 s) — click when built to train <strong>engineers</strong>, <strong>snipers</strong>, <strong>armored cars</strong>, <strong>tanks</strong>, and <strong>super heavies</strong>. Max 1.',
  ...
  },
  {
    ...
    body: [
      ...
      'Damaged units may <strong>retreat</strong> toward their HQ (RETREAT tag) and stop attacking until safe. <strong>Medics</strong> nearby reduce retreat chance and slowly heal infantry, MG, mortar, and sniper teams — a <strong>green cross</strong> floats above units being healed. <strong>Engineers</strong> repair nearby vehicles and steady panicked tank and gun crews — a <strong>spanner</strong> icon shows while a vehicle is being repaired. Vehicles below half HP trail <strong>black engine smoke</strong> until repaired. Defenders in Clear Defenses do not retreat.',
      ...
      '<strong>Engineer field works:</strong> Select an engineer → <strong>Build sandbags</strong> or <strong>Build bunker</strong> → LMB within ~24 m. The engineer moves to the site and erects the position. <strong>Sandbags</strong> (~11 s) are quick heavy-cover fighting pits. <strong>Bunkers</strong> (~28 s) are sturdier and hold up better under fire. In <strong>Base Building</strong> mode engineers can only build bunkers — they garrison foot troops like HQ-built bunkers (move a squad onto the completed bunker to enter). Not available in Tower Defence. Esc cancels placement.',
      '<strong>Campaign bunkers:</strong> In Base Building mode, <strong>Infantry Bunkers</strong> from HQ (95 supplies) or engineer field builds garrison foot troops — move a squad onto the bunker to enter. Garrisoned units take heavy-cover damage reduction and fight from the embrasures. Order a move away to exit. Max 6 bunkers per base (HQ + engineer combined).',
      'Destroyed units leave wrecks on the field: <strong>burning tanks</strong>, <strong>fallen infantry bodies</strong> (faction camo, prone on the ground for ~90 s), and knocked-out vehicles. Cover and retreat markers disappear on death.',
...
export const GUIDE_UNIT_CARDS = [
  ...
  },
  {
    ...
    build: 10,
    range: '—',
    desc: 'Non-combat — repairs vehicles within ~16 m; can erect sandbag pits or bunkers in the field (bunkers only in Base Building).',
