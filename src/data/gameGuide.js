...
export const GAME_GUIDE_SECTIONS = [
  ...
  },
  {
    ...
    controls: [
      ...
      ['Settings', 'Main menu — choose persistent defaults for battlefield toggles, Standard Auto Build, and how long bodies and destroyed vehicles remain'],
