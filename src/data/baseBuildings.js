...
export const BASE_BUILDING_TYPES = {
  ...
  motorPool: {
    id: 'motorPool',
    name: 'Motor Pool',
    subtitle: 'Click to train engineers, scouts, trucks, armor — repairs vehicles nearby',
    cost: 260,
    buildTime: 55,
    hp: 400,
    radius: 4.5,
    hitRadius: 5,
    unlocks: ['engineer', 'sniper', 'truck', 'armoredCar', 'tank', 'tankDestroyer', 'superHeavyTank'],
    spawns: ['engineer', 'sniper', 'truck', 'armoredCar', 'tank', 'tankDestroyer', 'superHeavyTank'],
    maxPerTeam: 1,
