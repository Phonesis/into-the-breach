...
const ICONS = {
  ...
  antiTankGun: `<svg viewBox="0 0 32 32" aria-hidden="true"><circle cx="8" cy="26" r="2.5" fill="currentColor"/><circle cx="24" cy="26" r="2.5" fill="currentColor"/><path d="M8 24h3l5-10 9 3-3 9H11" fill="none" stroke="currentColor" stroke-width="2.2" stroke-linejoin="round"/><path d="M20 14h8v2h-8" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round"/></svg>`,
