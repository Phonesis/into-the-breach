...
export const DEFENSE_SVG = {
  bunker: {
    ...
    japan: 'defenses/svg/bunker-japan.svg',
  },
  bunkerHeavy: {
    ...
    japan: 'defenses/svg/bunker-heavy-japan.svg',
  },
...
const BUNKER = {
  ...
  japan: {
    light: {
      ...
      height: 1.15,
      logs: 6,
      embrasure: { w: 0.88, h: 0.34, z: 2.25 },
      sandbagRing: { count: 12, radius: 3.1, y: 0.27 },
      hitRadius: 3.2,
    },
    heavy: {
      style: 'earth',
      ...
      height: 1.5,
      logs: 8,
      embrasure: { w: 1.08, h: 0.44, z: 2.65 },
      gun: { len: 3.25, r0: 0.15, r1: 0.18, y: 1.36, z: 2.8 },
      sandbagRing: { count: 15, radius: 3.72, y: 0.33 },
      hitRadius: 3.8,
    },
  },
};
