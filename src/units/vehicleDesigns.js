...
const DESIGNS = {
  germany: {
    ...
    artillery: {
      trailLen: 2.45,
      wheelR: 0.43,
      shield: { w: 1.12, h: 0.78, d: 0.12 },
      tube: { len: 2.65, elev: -0.44 },
      cradle: { w: 0.45, h: 0.3, d: 0.7, y: 1.0, z: 0.5 },
      hitRadius: 2.22,
    },
    antiTankGun: {
      trailLen: 2.15,
      wheelR: 0.4,
      shield: { w: 1.05, h: 1.58, d: 0.1 },
      tube: { len: 3.12, r0: 0.1, elev: -0.2 },
      hitRadius: 2.12,
    },
  },
  usa: {
    ...
    artillery: {
      trailLen: 2.25,
      wheelR: 0.44,
      shield: { w: 1.05, h: 0.35, d: 1.05 },
      tube: { len: 2.82, elev: -0.42, muzzleBrake: true },
      hitRadius: 2.32,
    },
    antiTankGun: {
      trailLen: 2.1,
      wheelR: 0.38,
      shield: { w: 0.95, h: 1.38, d: 0.1 },
      tube: { len: 2.88, r0: 0.09, elev: -0.2 },
      hitRadius: 2.1,
    },
  },
  uk: {
    ...
    artillery: {
      trailLen: 2.38,
      wheelR: 0.46,
      shield: { w: 1.18, h: 0.82, d: 0.14 },
      tube: { len: 2.52, elev: -0.4 },
      hitRadius: 2.26,
    },
    antiTankGun: {
      trailLen: 2.12,
      wheelR: 0.4,
      shield: { w: 1.0, h: 1.48, d: 0.11 },
      tube: { len: 2.98, r0: 0.092, elev: -0.2 },
      hitRadius: 2.1,
    },
  },
};