...
export const VEHICLE_SVG = {
  germany: {
    ...
    truck: 'vehicles/svg/truck-germany.svg',
  ...
  usa: {
    ...
    truck: 'vehicles/svg/truck-usa.svg',
  ...
  uk: {
    ...
    truck: 'vehicles/svg/truck-uk.svg',
  ...
  russia: {
    ...
    truck: 'vehicles/svg/truck-russia.svg',
    artillery: 'vehicles/svg/artillery-russia.svg',
    antiTankGun: 'vehicles/svg/at-gun-russia.svg',
  },
  japan: {
    tank: 'vehicles/svg/tank-medium-japan.svg',
    tankDestroyer: 'vehicles/svg/tank-destroyer-japan.svg',
    superHeavyTank: 'vehicles/svg/tank-super-japan.svg',
    armoredCar: 'vehicles/svg/armored-car-japan.svg',
    truck: 'vehicles/svg/truck-japan.svg',
    artillery: 'vehicles/svg/artillery-japan.svg',
    antiTankGun: 'vehicles/svg/at-gun-japan.svg',
  },
};
...
const DESIGNS = {
  germany: {
    ...
    truck: {
      model: 'opelBlitz',
      hull: { w: 1.88, h: 0.2, d: 4.62, y: 0.4, z: 0 },
      hood: { w: 1.02, h: 0.7, d: 1.32, y: 0.82, z: 1.52 },
      cab: { w: 1.68, h: 1.02, d: 0.92, y: 1.14, z: 0.52 },
      bed: { w: 1.74, h: 0.52, d: 2.18, y: 0.78, z: -1.08 },
      wheels: [
        [-0.92, 0.42, 1.42],
        [0.92, 0.42, 1.42],
        [-0.92, 0.42, -1.28],
      ...
      wheelR: 0.42,
      canvas: true,
      spare: { x: 0.98, y: 0.95, z: 0.08 },
      hitch: { x: 0, y: 0.44, z: -2.28 },
      cargo: {
        y: 0.86,
        slots: [
          { x: -0.46, z: -1.28 },
  ...
  usa: {
    ...
    truck: {
      model: 'cckw',
      hull: { w: 1.98, h: 0.2, d: 4.95, y: 0.4, z: 0 },
      hood: { w: 1.08, h: 0.72, d: 1.42, y: 0.84, z: 1.68 },
      cab: { w: 1.78, h: 1.08, d: 0.95, y: 1.18, z: 0.62 },
      bed: { w: 1.82, h: 0.5, d: 2.35, y: 0.8, z: -1.12 },
      wheels: [
        [-0.98, 0.4, 1.58],
        [0.98, 0.4, 1.58],
        [-0.98, 0.4, 0.08],
      ...
      wheelR: 0.4,
      canvas: true,
      spare: { x: 1.05, y: 0.98, z: 0.18 },
      hitch: { x: 0, y: 0.44, z: -2.42 },
      cargo: {
        y: 0.88,
        slots: [
          { x: -0.5, z: -1.38 },
  ...
  uk: {
    ...
    truck: {
      model: 'bedfordQl',
      cabOver: true,
      hull: { w: 1.9, h: 0.2, d: 4.48, y: 0.4, z: 0 },
      hood: { w: 1.62, h: 0.58, d: 0.38, y: 0.82, z: 1.92 },
      cab: { w: 1.78, h: 1.18, d: 1.28, y: 1.2, z: 1.22 },
      bed: { w: 1.76, h: 0.5, d: 2.22, y: 0.78, z: -0.85 },
      wheels: [
        [-0.94, 0.4, 1.28],
        [0.94, 0.4, 1.28],
        [-0.94, 0.4, -1.18],
      ...
      wheelR: 0.4,
      canvas: true,
      spare: { x: 1.02, y: 0.96, z: 0.42 },
      hitch: { x: 0, y: 0.44, z: -2.08 },
      cargo: {
        y: 0.86,
        slots: [
          { x: -0.46, z: -1.12 },
  ...
  russia: {
    ...
    truck: {
      model: 'zis5',
      hull: { w: 1.92, h: 0.2, d: 4.72, y: 0.4, z: 0 },
      hood: { w: 1.08, h: 0.78, d: 1.38, y: 0.86, z: 1.55 },
      cab: { w: 1.7, h: 1.05, d: 0.9, y: 1.16, z: 0.5 },
      bed: { w: 1.78, h: 0.54, d: 2.28, y: 0.78, z: -1.12 },
      wheels: [
        [-0.94, 0.42, 1.48],
        [0.94, 0.42, 1.48],
        [-0.94, 0.42, -1.32],
      ...
      wheelR: 0.42,
      canvas: true,
      spare: { x: 1.0, y: 0.96, z: 0.06 },
      hitch: { x: 0, y: 0.44, z: -2.36 },
      cargo: {
        y: 0.86,
        slots: [
          { x: -0.48, z: -1.32 },
  ...
  japan: {
    tank: {
      model: 'shinhotoChiHa',
      hull: { w: 2.12, h: 0.62, d: 3.35, y: 0.54, z: 0.02 },
      glacis: { w: 1.92, h: 0.5, d: 1.16, y: 0.68, z: 1.45, tilt: -0.35 },
      track: { spread: 1.12, height: 0.48, length: 3.28, wheels: 6, wheelR: 0.18, fender: true, links: 13 },
      turret: { style: 'box', w: 1.3, h: 0.5, d: 1.3, y: 1.06, z: -0.1, bustle: true },
      barrel: { len: 2.25, r0: 0.07, r1: 0.09, y: 1.06, z: 1.45, mantlet: true },
      coax: { len: 0.42, y: 1.0, z: 0.28 },
      antenna: { h: 0.54, y: 1.3, z: -0.48 },
      cupola: { x: -0.2, r: 0.14, h: 0.15, z: -0.4 },
      hatches: [
        { turret: true, x: 0.18, y: 1.34, z: -0.34, ry: 0.12 },
        { x: -0.38, y: 0.86, z: 0.95, ry: -0.12 },
      ],
      bowMg: { x: -0.4, y: 0.7, z: 1.62, len: 0.36 },
      stowageBins: [{ w: 0.14, h: 0.2, d: 0.58, x: 0.08, y: 0.75, z: -0.66 }],
      exhausts: [{ x: 0.48, y: 0.72, z: -1.62, h: 0.34 }],
      hitRadius: 2.12,
    },
    tankDestroyer: {
      model: 'hoNi1',
      hull: { w: 2.14, h: 0.6, d: 3.38, y: 0.52, z: 0.02 },
      glacis: { w: 1.94, h: 0.1, d: 1.12, y: 0.7, z: 1.26, tilt: 0.28 },
      track: { spread: 1.13, height: 0.48, length: 3.32, wheels: 6, wheelR: 0.18, fender: true, links: 13 },
      superstructure: { style: 'openTurret', w: 1.62, h: 0.66, d: 1.34, y: 1.08, z: 0.02, rearCounterweight: false },
      barrel: { len: 2.92, r0: 0.09, r1: 0.11, y: 1.14, z: 1.58, mantlet: 'box', muzzleBrake: 'single' },
      hatches: [{ x: -0.36, y: 0.84, z: 0.95, ry: 0.16 }],
      exhausts: [{ x: 0.5, y: 0.7, z: -1.64, h: 0.34 }],
      spareTrack: [{ w: 0.78, h: 0.07, d: 0.18, y: 0.85, z: 1.65 }],
      hitRadius: 2.22,
    },
    superHeavyTank: {
      model: 'chiNu',
      hull: { w: 2.2, h: 0.66, d: 3.58, y: 0.56, z: 0.02 },
      glacis: { w: 2.0, h: 0.54, d: 1.24, y: 0.7, z: 1.55, tilt: -0.32 },
      track: { spread: 1.16, height: 0.5, length: 3.5, wheels: 6, wheelR: 0.19, fender: true, links: 14 },
      turret: { style: 'box', w: 1.52, h: 0.62, d: 1.48, y: 1.16, z: -0.08, bustle: true },
      barrel: { len: 2.82, r0: 0.095, r1: 0.115, y: 1.16, z: 1.72, mantlet: true, muzzleBrake: 'single' },
      coax: { len: 0.42, y: 1.1, z: 0.34 },
      cupola: { x: -0.22, r: 0.15, h: 0.17, z: -0.46 },
      hatches: [
        { turret: true, x: 0.22, y: 1.5, z: -0.38 },
        { x: -0.4, y: 0.9, z: 1.08 },
      ],
      bowMg: { x: -0.42, y: 0.74, z: 1.72, len: 0.38 },
      stowageBins: [{ w: 0.15, h: 0.21, d: 0.64, x: 0.08, y: 0.78, z: -0.72 }],
      exhausts: [{ x: 0.52, y: 0.74, z: -1.74, h: 0.36 }],
      hitRadius: 2.3,
    },
    armoredCar: {
      model: 'chiyoda',
      hull: { w: 1.82, h: 0.5, d: 3.42, y: 0.52 },
      nose: { w: 1.46, h: 0.38, d: 0.9, y: 0.54, z: 1.32, tilt: -0.26 },
      rear: { w: 1.5, h: 0.5, d: 0.84, y: 0.55, z: -1.28 },
      wheels: [
        [-0.9, 0.32, -1.1],
        [0.9, 0.32, -1.1],
        [-0.9, 0.32, 0],
      ...
      wheelR: 0.33,
      turret: { style: 'box', w: 0.94, h: 0.4, d: 0.9, y: 0.96, z: -0.04 },
      barrel: { len: 0.68, r0: 0.045, r1: 0.052, y: 1.0, z: 0.48, offsetX: 0.18 },
      secondaryGun: { len: 0.52, y: 0.98, z: 0.4 },
      hitRadius: 2.08,
    },
    truck: {
      model: 'type94Isuzu',
      hull: { w: 1.82, h: 0.2, d: 4.55, y: 0.4, z: 0 },
      hood: { w: 0.98, h: 0.66, d: 1.28, y: 0.8, z: 1.48 },
      cab: { w: 1.62, h: 0.98, d: 0.88, y: 1.1, z: 0.5 },
      bed: { w: 1.68, h: 0.48, d: 2.12, y: 0.76, z: -1.05 },
      wheels: [
        [-0.88, 0.38, 1.42],
        [0.88, 0.38, 1.42],
        [-0.88, 0.38, 0.05],
      ...
      wheelR: 0.38,
      canvas: true,
      spare: { x: 0.94, y: 0.9, z: 0.12 },
      hitch: { x: 0, y: 0.42, z: -2.22 },
      cargo: {
        y: 0.82,
        slots: [
          { x: -0.42, z: -1.22 },
    ...
    artillery: {
      ...
      trailLen: 2.2,
      wheelR: 0.42,
      carriage: { wheelSpread: 0.72, axleZ: -0.08, trailSpread: 0.52 },
      shield: { w: 1.0, h: 0.7, d: 0.11, style: 'tall', y: 0.86, z: 0.32 },
      tube: { len: 2.48, elev: 0, r0: 0.09, r1: 0.11, breechLen: 0.34 },
      cradle: { w: 0.44, h: 0.26, d: 0.7, y: 0.8, z: 0.38 },
      hitRadius: 2.18,
    },
    antiTankGun: {
      model: 'type1_47',
      trailLen: 1.92,
      wheelR: 0.36,
      carriage: { wheelSpread: 0.66, axleZ: -0.04, trailSpread: 0.48 },
      shield: { w: 0.9, h: 1.22, d: 0.09, style: 'at', y: 0.78, z: 0.22 },
      tube: { len: 2.52, r0: 0.075, r1: 0.09, elev: 0, breechLen: 0.28 },
      hitRadius: 2.0,
    },
  },
};
