  ...
  const snapshot = {
    ...
    engineerSandbags: {
      ...
      mines: (game.engineerSandbags?.mines ?? []).map((mine) => ({
        ...
        y: mine.y,
        damage: mine.damage,
        damageByVehicleType: mine.damageByVehicleType,
...
function restoreEngineerMine(manager, data) {
  ...
  manager.mines.push({
    ...
    damageByVehicleType:
      data.damageByVehicleType ?? DEFENSE_TYPES.mine.damageByVehicleType,
    triggerRadius: data.triggerRadius ?? DEFENSE_TYPES.mine.triggerRadius,
    blastRadius: data.blastRadius ?? DEFENSE_TYPES.mine.blastRadius,
    mesh,
    _aiDefensiveFieldwork: !!data.aiDefensiveFieldwork,
    _aiFieldworkMode: data.aiFieldworkMode ?? null,
  });
